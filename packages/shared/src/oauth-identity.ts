 ...
 * carry the Claude Code OAuth beta headers. Otherwise Anthropic rejects the call
 * (often as a misleading 429 with no rate-limit headers). The sandbox auth
...
export const ANTHROPIC_OAUTH_BETA = "oauth-2025-04-20, claude-code-20250219";
